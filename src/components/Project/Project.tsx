...
import pdf from  "../../assets/Design By Kanhiya.pdf"
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://www.ngoalliance.life/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" /></a>
              </div>
            </header>
            <div className="body">
              <h3>Charity Hub</h3>
              <p>Developed a website that provides centralized access to various charity organizations, built using HTML, CSS, and JavaScript. This project highlights advanced front-end development skills, focusing on creating an intuitive and responsive layout. By working on this project, I enhanced my understanding of web design and development, particularly in structuring complex layouts and incorporating interactive features using JavaScript.</p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <img src={externalLink} alt="View PDF" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Graphic Designing</h3>
              <p>During my internship, I created designs for my company using Figma and CorelDRAW. These designs showcase essential design skills, emphasizing user interface design and visual aesthetics. By working on this project, I developed a strong understanding of creating engaging and user-friendly layouts, while focusing on design principles that enhance the overall user experience.</p>
            </div>
            <footer>
              <ul className="tech-list">
              <li>FIGMA</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"> <title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://netflix-clone-by-kanhiya.netlify.app/" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a> </div>
            </header>
            <div className="body">
              <h3>Netflix Homepage</h3>
              <p> Developed a visually accurate clone of the Netflix homepage using only HTML and CSS. This project showcase advanced skills in front-end development, emphasizing clean,and precise layout replication. By implementing this project, I enhanced understanding of HTML and CSS, particularly in complex layout and styling techniques.</p>
            </div>
